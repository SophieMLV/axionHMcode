...
def func_cut_mass_axion_halo(cosmo_dic, power_spec_dic):
    ...
    def func_find_root(m):
        return func_jeans_virial_ratio(m, cosmo_dic, power_spec_dic) -1
