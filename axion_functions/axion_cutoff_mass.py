...
def func_halo_jeans_kscale(M, cosmo_dic, power_spec_dic_sigma, axion_dic=None):
    """
...
def func_jeans_virial_ratio(M, cosmo_dic, power_spec_dic_sigma, axion_dic=None):
    """
    M is given in solar_mass/h
    returns the ratio between the halo jeans scale and the virial radius
    """
    halo_jeans_scale = np.pi / func_halo_jeans_kscale(M, cosmo_dic, power_spec_dic_sigma, axion_dic=axion_dic) # in Mpc/h
...
def func_cut_mass_axion_halo(cosmo_dic, power_spec_dic_sigma, axion_dic=None):
    """
    ...
    def func_find_root(m):
        return func_jeans_virial_ratio(m, cosmo_dic, power_spec_dic_sigma, axion_dic=axion_dic) -1
