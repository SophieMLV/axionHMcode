...
def func_halo_jeans_kscale(M, cosmo_dic, power_spec_dic, c_min, axion_dic=None):
    """
    ...
    concentration = func_conc_param(M, power_spec_dic['k'], power_spec_dic['power_cold'], 
                                    cosmo_dic, cosmo_dic['Omega_db_0'], c_min, axion_dic=axion_dic)
...
def func_jeans_virial_ratio(M, cosmo_dic, power_spec_dic, c_min, axion_dic=None):
    """
...
def func_cut_mass_axion_halo(cosmo_dic, power_spec_dic, c_min, axion_dic=None):
    """
