...
def func_axion_param_dic(M, cosmo_dic, power_spec_dic_sigma):
    ...
    #print('Line 2')
    axion_param_dic['central_dens'] = func_central_density_param(axion_param_dic['M_int'], cosmo_dic, power_spec_dic_sigma, axion_param_dic['M_cut'], eta_given=False, axion_dic=axion_param_dic)
