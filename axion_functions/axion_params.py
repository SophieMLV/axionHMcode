...
def func_axion_param_dic(M, cosmo_dic, power_spec_dic):
    ...
    axion_param_dic['M_cut'] = func_cut_mass_axion_halo(cosmo_dic, power_spec_dic)
    ...
    axion_param_dic['central_dens'] = func_central_density_param(axion_param_dic['M_int'], cosmo_dic, power_spec_dic, axion_param_dic['M_cut'], eta_given=False)
