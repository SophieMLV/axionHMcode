...
@njit
def func_delta_c(z, Omega_ax_0, Omega_m_0, Omega_w_0, G_a):
    """
...
@njit    
def func_Delta_vir(z, Omega_ax_0, Omega_m_0, Omega_w_0, G_a):
    """
...
# @njit
def func_r_vir(z, M, Omega_ax_0, Omega_0, Omega_m_0, Omega_w_0, G_a):
    """
    M in solar_mass/h where M is matter of the type Omega_0
    returns comoving virial radius in Mpc/h
    """
    Delta_vir = func_Delta_vir(z, Omega_ax_0, Omega_m_0, Omega_w_0, G_a)
