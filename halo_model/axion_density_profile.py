...
def func_central_density_param(M, cosmo_dic, power_spec_dic, M_cut, concentration_param=False, eta_given=False, axion_dic=None):
    ...
    if isinstance(M, (int, float)) == True:
        if M < M_cut:
            ...
            # def integrand_ax(x):
            #     return func_dens_profile_ax(x, M, cosmo_dic, power_spec_dic, M_cut, 1., 
            #                                   concentration_param=concentration_param, eta_given=eta_given, axion_dic=axion_dic)*x**2
            ...
            def func_find_root(dens):
                return func_ax_halo_mass(M, cosmo_dic, power_spec_dic, M_cut, dens, hmcode_dic, 
                                         concentration_param=concentration_param, eta_given=eta_given, axion_dic=axion_dic) - cosmo_dic['Omega_ax_0']/cosmo_dic['Omega_db_0'] * M
        ...
        for idx, m in enumerate(M):
            if m < M_cut:
                ...
                #so we need the soliton and NFW part
                # def integrand_ax(x):
                #     return func_dens_profile_ax(x, m, cosmo_dic, power_spec_dic, M_cut, 1., hmcode_dic, 
                #                                   concentration_param=concentration_param, eta_given=eta_given, axion_dic=axion_dic)*x**2
                ...
                def func_find_root(dens):
                    return func_ax_halo_mass(m, cosmo_dic, power_spec_dic, M_cut, dens, hmcode_dic, 
                                             concentration_param=False, eta_given=eta_given, axion_dic=axion_dic) - cosmo_dic['Omega_ax_0']/cosmo_dic['Omega_db_0'] * m
